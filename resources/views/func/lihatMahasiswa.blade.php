                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('mahasiswa.create') }}" class="btn btn-sm btn-primary">Add</a>
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>
                                                <a class="btn btn-sm btn-info" href="/mahasiswa/{{$key->id}}">Show</a>
                                            </li>
                                            <li>
                                                <a class="btn btn-sm btn-success" href="{{route('mahasiswa.edit', $key->id)}}">Edit</a>
                                            </li>
                                            <li>
                                                <form method="POST" action="{{route('mahasiswa.destroy', $key->id)}}">
                                                    @csrf
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>Anda yakin ingin menghapus Mahasiswa dengan ID : {{$key->id}} ?</p>
                                                                </div>
