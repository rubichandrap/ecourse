                        ...
                        <form method="POST" action="{{ route('dosen.store') }}">
                            ...
                            <div class="table-responsive">
                                <table class="mb-0 table align-items-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input class="form-control cstm pl-2 @error('nbm_nim') is-invalid @enderror" type="text" name="nbm_nim" value="{{ old('nbm_nim') }}" placeholder="Masukkan NBM">
                                                @error('nbm_nim')
                                            ...
                                            <td>
                                                <select class="form-control cstm pl-2 @error('major') is-invalid @enderror" name="major" disabled readonly>
