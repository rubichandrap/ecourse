        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-0 bg-transparent">
                    <li class="breadcrumb-item"><a class="text-white" href="{{ route('dosen.index') }}">Dosen</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="{{ route('dosen.show', $dosen->id) }}">{{ $dosen->name }}</a></li>
        ...
        <div class="row">
                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="mailto:{{ $dosen->email }}" target="_blank" class="btn btn-sm btn-default float-right">Kirim Email</a>
                        </div>
                    </div>
            ...
            <div class="col-xl-8 order-xl-1">
                <div class="card bg-secondary shadow">
                    <form id="form-edit" method="POST" action="{{route('dosen.update', $id)}}" enctype="multipart/form-data">
                        <input type="hidden" name="_method" value="PATCH" />
                        @csrf
                        <div class="card-header bg-white border-0">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">Edit Dosen Dengan ID : {{$id}}</h3>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="input-nbm-nim" class="form-control @error('nbm_nim') is-invalid @enderror form-control-alternative" name="nbm_nim" value="{{ $dosen->nbm_nim }}" placeholder="000001">
                                            @error('nbm_nim')
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="input-username" class="form-control @error('username') is-invalid @enderror form-control-alternative" name="username" value="{{ $dosen->username}}" placeholder="johndoe">
                                            @error('username')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="input-name" class="form-control @error('name') is-invalid @enderror form-control-alternative" name="name" value="{{ $dosen->name }}" placeholder="John Doe">
                                            @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <select id="input-major" class="form-control @error('major') is-invalid @enderror form-control-alternative" name="major" readonly disabled>
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="input-email" class="form-control @error('email') is-invalid @enderror form-control-alternative" name="email" value="{{ $dosen->email }}" placeholder="johndoe@example.com">
                                            @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <select id="input-status" class="form-control form-control-alternative" name="status">
                                                <option {{ $dosen->status == '1' ? 'selected' : '' }} value="1">Aktif</option>
                                                <option {{ $dosen->status == '0' ? 'selected' : '' }} value="0">Non-Aktif</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <select id="input-role" class="form-control form-control-alternative" name="role">
                                                <option {{ $dosen->roles[0]->name == 'dosen' ? 'selected' : '' }} value="dosen">Dosen</option>
                                                <option {{ $dosen->roles[0]->name == 'mahasiswa' ? 'selected' : '' }} value="mahasiswa">Mahasiswa</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
