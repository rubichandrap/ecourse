                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a class="btn btn-sm btn-primary" href="{{route('dosen.edit', $dosen->id)}}">Edit User</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-nbm-nim" class="form-control form-control-alternative" name="nbm_nim" value="{{ $dosen->nbm_nim }}" placeholder="000001" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-2">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-username">Username</label>
                                        <input type="text" id="input-username" class="form-control form-control-alternative" name="username" value="{{ $dosen->username}}" placeholder="johndoe" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-2">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-name">Nama</label>
                                        <input type="text" id="input-name" class="form-control form-control-alternative" name="name" value="{{ $dosen->name }}" placeholder="John Doe" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-2">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-major">Major</label>
                                        <input type="text" id="input-major" class="form-control form-control-alternative" name="major" value="{{ $dosen->majors->count() > 0 ? $dosen->majors[0]->name : '-' }}" placeholder="Sistem Informasi" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-2">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-email">Email</label>
                                        <input type="text" id="input-email" class="form-control form-control-alternative" name="email" value="{{ $dosen->email }}" placeholder="johndoe@example.com" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-2">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-status">Status</label>
                                        <input type="text" id="input-status" class="form-control form-control-alternative" name="status" value="{{ $dosen->status == '1' ? 'Aktif' : 'Non-Aktif' }}" placeholder="Non-Aktif" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-2">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-role">Role</label>
                                        <input type="text" id="input-role" class="form-control form-control-alternative" name="role" value="{{ $dosen->roles[0]->name }}" placeholder="Non-Aktif" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
